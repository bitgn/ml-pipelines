...
class DatasetVersionAdded(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"dataset_uid",u"inputs",u"items",u"parent_uid",u"project_name",u"project_uid",u"timestamp",u"title",u"uid"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[u"dataset_uid",b"dataset_uid",u"inputs",b"inputs",u"items",b"items",u"parent_uid",b"parent_uid",u"project_name",b"project_name",u"project_uid",b"project_uid",u"timestamp",b"timestamp",u"title",b"title",u"uid",b"uid"]) -> None: ...

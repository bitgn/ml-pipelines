...
class ApiError(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        ...
        subject_id : typing___Optional[typing___Text] = None,
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"code",u"details",u"message",u"subject_id"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[u"code",b"code",u"details",b"details",u"message",b"message",u"subject_id",b"subject_id"]) -> None: ...

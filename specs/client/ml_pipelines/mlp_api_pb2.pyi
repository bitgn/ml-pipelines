...
class LookupDatasetRequest(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    project_name = ... # type: typing___Text
    dataset_name = ... # type: typing___Text

    def __init__(self,
        *,
        project_name : typing___Optional[typing___Text] = None,
        dataset_name : typing___Optional[typing___Text] = None,
        ) -> None: ...
    @classmethod
    def FromString(cls, s: bytes) -> LookupDatasetRequest: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"dataset_name",u"project_name"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[u"dataset_name",b"dataset_name",u"project_name",b"project_name"]) -> None: ...

class LookupDatasetResponse(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    project_uid = ... # type: bytes
    ...
    @classmethod
    def FromString(cls, s: bytes) -> LookupDatasetResponse: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"error"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"dataset_uid",u"error",u"project_uid"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"error",b"error"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"dataset_uid",b"dataset_uid",u"error",b"error",u"project_uid",b"project_uid"]) -> None: ...

class AddDatasetVersionRequest(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    dataset_uid = ... # type: bytes
    parent_uid = ... # type: bytes
    title = ... # type: typing___Text
    timestamp = ... # type: int
    inputs = ... # type: google___protobuf___internal___containers___RepeatedScalarFieldContainer[bytes]
    ...
    def __init__(self,
        *,
        ...
        inputs : typing___Optional[typing___Iterable[bytes]] = None,
        ) -> None: ...
    @classmethod
    def FromString(cls, s: bytes) -> AddDatasetVersionRequest: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"dataset_uid",u"inputs",u"items",u"parent_uid",u"timestamp",u"title"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[u"dataset_uid",b"dataset_uid",u"inputs",b"inputs",u"items",b"items",u"parent_uid",b"parent_uid",u"timestamp",b"timestamp",u"title",b"title"]) -> None: ...

class AddDatasetVersionResponse(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    uid = ... # type: bytes
    ...
    @classmethod
    def FromString(cls, s: bytes) -> AddDatasetVersionResponse: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"error"]) -> bool: ...

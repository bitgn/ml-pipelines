...
class AddDatasetActivityRequest(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    project_id = ... # type: typing___Text
    dataset_id = ... # type: typing___Text
    ...
    @classmethod
    def FromString(cls, s: bytes) -> AddDatasetActivityRequest: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"dataset_id",u"level",u"multiline_text",u"project_id",u"timestamp"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[u"dataset_id",b"dataset_id",u"level",b"level",u"multiline_text",b"multiline_text",u"project_id",b"project_id",u"timestamp",b"timestamp"]) -> None: ...

class AddDatasetActivityResponse(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    ...
    @classmethod
    def FromString(cls, s: bytes) -> AddDatasetActivityResponse: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"error"]) -> bool: ...
